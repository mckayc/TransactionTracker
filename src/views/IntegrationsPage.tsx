...
import { PuzzleIcon, ArrowRightIcon, BoxIcon, PlayIcon } from '../components/Icons';
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <IntegrationCard 
                    ...
                    description="Track video revenue, views, and RPM. Import 'Content' reports directly from YouTube Studio."
