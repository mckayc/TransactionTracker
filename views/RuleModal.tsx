    ...
    return (
        <>
                ...
                <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-6xl h-full max-h-[92vh] flex flex-col overflow-hidden animate-slide-up" onClick={e => e.stopPropagation()}>
                    <div className="flex justify-between items-center p-6 border-b bg-white sticky top-0 z-20 shadow-sm">
                        ...
                        <div className="flex items-center gap-2">
                            {isExistingRule && (
                                <button type="button" onClick={() => setIsConfirmDeleteOpen(true)} className="px-5 py-2.5 text-xs font-black uppercase bg-red-50 text-red-600 rounded-xl hover:bg-red-100 flex items-center gap-2 mr-2">
            ...
            <ConfirmationModal 
                ...
                message={`You are about to permanently remove "${name}". This logic will no longer be applied to incoming transactions. Existing transactions in your ledger will not be changed.`}
