...
import { CloseIcon, SlashIcon, SparklesIcon, AddIcon, PlayIcon, TypeIcon, ExclamationTriangleIcon, InfoIcon, DatabaseIcon, ChevronDownIcon } from '../components/Icons';
                            ...
                            <div className="flex justify-between items-start">
                                <div>
                                    <h4 className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-1 flex items-center gap-2">
                                        <DatabaseIcon className="w-3 h-3" /> Historical Source Reference
                                    </h4>
                                ...
                                >
                                    ...
                                    {showMetadata ? 'Hide Keys' : 'View Metadata Keys'}
                                </button>
                            </div>
